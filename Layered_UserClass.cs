...
namespace ConsoleApp1
{
            ...
            while (true)
            {
                ...
                else if (input == 2)
                {
                    ...
                    if (n == 1)
                    {
                        ...
                        if (userManager.IsPresentUserById(id) == true) userManager.RemoveUserbyId(id);
                    ...
                    else if (n == 2)
                    {
                        ...
                        int IdByName = userManager.FindUserIDByName(name);
                        if (IdByName != -1) userManager.RemoveUserbyId(IdByName);
    ...
    public class UserManager
    {
        ...
        {
            ListNode<int> listNode = new ListNode<int>();

            listNode.AddAtStart(listNode, 10);
            listNode.AddAtStart(listNode, 20);
            listNode.AddAtStart(listNode, 30);
            listNode.AddAtStart(listNode, 40);

            listNode.PrintList(listNode);
            Console.WriteLine(listNode.SearchElement(listNode, 30));
